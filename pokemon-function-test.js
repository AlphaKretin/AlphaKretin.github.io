...
function clicked(){
	for (var i = 0; i < abilities.length; i++){
		document.getElementById("myDiv").innerHTML += "var " + abilities[i].replace(/ /g,"_") + " = {<br />&nbsp;&nbsp;&nbsp;&nbsp;name: \"" + c(abilites[i]) + "\",<br />&nbsp;&nbsp;&nbsp;&nbsp;desc: \"Powers up moves of the same type.\",<br />&nbsp;&nbsp;&nbsp;&nbsp;wiki: \"http:\/\/bulbapedia.bulbagarden.net\/wiki\/" + u(abilities[i]) + "_(Ability)\"<br />};<br /><br />"
	}
}
