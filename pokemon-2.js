...
function clicked(){
	for (var i = 0; i < moves.length; i++){
		if (zmoves.indexOf(moves[i]) === -1){
			document.getElementById("myDiv").innerHTML += "var " + moves[i].replace(/ /g,"_") + " = {<br />&nbsp;&nbsp;&nbsp;&nbsp;name: \"" + eval(moves[i].replace(/ /g,"_")).name + "\",<br />&nbsp;&nbsp;&nbsp;&nbsp;desc: \"" + eval(moves[i].replace(/ /g,"_")).desc + "\",<br />&nbsp;&nbsp;&nbsp;&nbsp;wiki: \"" + eval(moves[i].replace(/ /g,"_")).wiki + "\"<br />};<br /><br />"
		} else {
			document.getElementById("myDiv").innerHTML += "var " + moves[i].replace(/ /g,"_") + " = {<br />&nbsp;&nbsp;&nbsp;&nbsp;name: \"" + eval(moves[i].replace(/ /g,"_")).name + "\",<br />&nbsp;&nbsp;&nbsp;&nbsp;desc: \"" + eval(moves[i].replace(/ /g,"_")).desc + "\",<br />&nbsp;&nbsp;&nbsp;&nbsp;zdesc: \"" + zeffects[zmoves.indexOf(moves[i])] + "\",<br />&nbsp;&nbsp;&nbsp;&nbsp;wiki: \"" + eval(moves[i].replace(/ /g,"_")).wiki + "\"<br />};<br /><br />"
		}
	}
}
