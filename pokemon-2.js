...
function clicked(){
	for (var i = 0; i < abilities.length; i++){
		if (zmoves.indexOf(moves[i]) === -1){
			...
			document.getElementById("myDiv").innerHTML += "var " + abilities[i].replace(/ /g,"_") + " = {<br />&nbsp;&nbsp;&nbsp;&nbsp;name: \"" + c(abilities[i]) + "\",<br />&nbsp;&nbsp;&nbsp;&nbsp;desc: \"" + descs[i] + "\",<br />&nbsp;&nbsp;&nbsp;&nbsp;zdesc: \"" + zeffects[zmoves.indexOf(moves[i])] + "\",<br />&nbsp;&nbsp;&nbsp;&nbsp;wiki: \"http:\/\/www.serebii.net\/abilitydex\/" + u(abilities[i]) + ".shtml\"<br />};<br /><br />"
		}
	}
}
