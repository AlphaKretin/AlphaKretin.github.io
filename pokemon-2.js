...
function clicked(){
	for (var i = 0; i < abilities.length; i++){
		document.getElementById("myDiv").innerHTML += "var " + abilities[i].replace(/ /g,"_") + " = {<br />&nbsp;&nbsp;&nbsp;&nbsp;name: \"" + c(abilities[i]) + "\",<br />&nbsp;&nbsp;&nbsp;&nbsp;desc: \"Powers up moves of the same type.\",<br />&nbsp;&nbsp;&nbsp;&nbsp;wiki: \"http:\/\/www.serebii.net\/abilitydex\/" + u(abilities[i]) + ".shtml\"<br />};<br /><br />"
	}
}
