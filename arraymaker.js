...
function clicked(){
	...
	for (var mon of mons){
		mon = mon.replace(/ /g, "_");
		out += "{id: \"" + mon.replace(/_/g, " ") + "\", name: \"" + eval(mon).name + "\", dex: " + eval(mon).dex + ", alola: " + eval(mon).alola + ", type: \"" + eval(mon).type + "\", ability: \"" + eval(mon).ability + "\", wiki: \"" + eval(mon).wiki + "\", image: \"" + eval(mon).image + "\"}, ";
		console.log(mon);
	}
